...
export default angular.module('mcrissDemoApp.treeGrid', [])
  ...
  .directive('treeGrid', ['$timeout',function ($timeout) {
    return {
      ...
      link: function (scope, element, attrs) {
        ...
        attrs.iconExpand = attrs.iconExpand ? attrs.iconExpand : 'fa fa-plus-square';
        attrs.iconCollapse = attrs.iconCollapse ? attrs.iconCollapse : 'fa fa-minus-square';
        attrs.iconLeaf = attrs.iconLeaf ? attrs.iconLeaf : 'fa fa-square-o';
...
//        attrs.expandLevel = attrs.expandLevel ? attrs.expandLevel : '0';
        ...
        //allow actions other than clicking the table rows to set the current row selection
        function on_set_selection() {
          return $timeout(function () {
            scope.selectedRs.expanded = true;
            if (scope.selectedRs !== selected_branch) {
              return select_branch(scope.selectedRs);
            }
          });
        };
